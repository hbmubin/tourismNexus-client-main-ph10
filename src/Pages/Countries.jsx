          ...
          <div className="hero-content text-center text-neutral-content">
            <div className="max-w-md">
              ...
              <p className="mb-5">
                ...
                forest, offering a captivating blend of tropical flora and
                fauna.
              </p>
        ...
        >
          ...
          <div className="hero-content text-center text-neutral-content">
            <div className="max-w-md">
              ...
              <p className="mb-5">
                Cambodia boasts natural beauty with its ancient Angkorian
                temples nestled amidst lush jungles, serene Tonle Sap Lake with
                floating villages, and the tranquil Cardamom Mountains adorned
                with waterfalls and diverse wildlife. The country's landscapes
                blend history and nature, offering unique experiences to
                visitors.
              </p>
              <div className="text-2xl text-neutral-300 font-semibold">
                Press to Show All
        ...
        >
          ...
          <div className="hero-content text-center text-neutral-content">
            <div className="max-w-md">
              ...
              <p className="mb-5">
                Vietnam captivates with its natural beauty, featuring
                picturesque landscapes of towering limestone karsts in Halong
                Bay, lush terraced rice paddies in Sapa, and pristine beaches
                along the central coast. The country's diverse ecosystems also
                include dense forests, winding rivers, and scenic waterfalls,
                offering enchanting experiences for travelers.
              </p>
              <div className="text-2xl text-neutral-300 font-semibold">
                Press to Show All
              </div>
          ...
          <div className="hero-content text-center text-neutral-content">
            <div className="max-w-md">
              ...
              <p className="mb-5">
                ...
                biodiversity and vibrant coral reefs make it a paradise for
